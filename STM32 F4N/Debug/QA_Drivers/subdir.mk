...
clean-QA_Drivers:
	-$(RM) ./QA_Drivers/QAD_ADC.d ./QA_Drivers/QAD_ADC.o ./QA_Drivers/QAD_EXTI.d ./QA_Drivers/QAD_EXTI.o ./QA_Drivers/QAD_Encoder.d ./QA_Drivers/QAD_Encoder.o ./QA_Drivers/QAD_Flash.d ./QA_Drivers/QAD_Flash.o ./QA_Drivers/QAD_GPIO.d ./QA_Drivers/QAD_GPIO.o ./QA_Drivers/QAD_I2C.d ./QA_Drivers/QAD_I2C.o ./QA_Drivers/QAD_PWM.d ./QA_Drivers/QAD_PWM.o ./QA_Drivers/QAD_RGB.d ./QA_Drivers/QAD_RGB.o ./QA_Drivers/QAD_SPI.d ./QA_Drivers/QAD_SPI.o ./QA_Drivers/QAD_Servo.d ./QA_Drivers/QAD_Servo.o ./QA_Drivers/QAD_Timer.d ./QA_Drivers/QAD_Timer.o ./QA_Drivers/QAD_UART.d ./QA_Drivers/QAD_UART.o
