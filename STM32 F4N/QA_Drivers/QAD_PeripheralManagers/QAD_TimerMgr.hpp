...
typedef struct {
	...
	TIM_TypeDef*      pInstance;     //Stores the TIM_TypeDef for the Timer peripheral (defined in stm32f411xe.h)

	IRQn_Type         eIRQ_Update;   //Stores the IRQ Handler enum for the Timer peripheral (defined in stm32f411xe.h)
